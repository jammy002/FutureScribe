import { Button, Drawer, Menu, rem, useMantineColorScheme } from '@mantine/core';
 ...
 return (
  <Menu  shadow = "md" width={200}>
   ...
   <Menu.Dropdown>
    ...
    <Menu.Item leftSection={<AiOutlineLogout style={{ width:rem(14), height:rem(14)}}/>
    }
...
const Navbar = () => {
 ...
 return (
    <div className='w-full fixed top-0 z-50 bg-transparent flex flex-row px-4 
    md:px-6 py-4 md:py-5 items-center justify-between gap-4 shadow'> 
          ...
          <div className='flex gap-2 items-center'>  
            {
              ...
              <UserMenu user={user?.user} theme={theme} />
               ...
               to="/auth"
               onClick={handleLogin}
               className={clsx("flex items-center gap-2 rounded-full 2xl:mr-10 text-base", 
