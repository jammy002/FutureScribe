...
const Followers = () => {
  ...
  return (<div className="w-full flex flex-col">
    ...
    <Table highlightOnHover withColumnBorders className="flex-1">
      <Table.Thead>
        <Table.Tr>
      ...
      <Table.Tbody>
        {data?.data?.map(({ _id, followerId, createdAt }) => (
          ...
          >
            ...
            <Table.Td> <p className={`${followerId?.accountType === "User"
          ? "bg-rose-800 text-rose-800"
           : "bg-blue-800 text-blue-800"} bg-opacity-30 font-semibold px-4 p-1 rounded-full w-fit `}>
    ...
    <div className="w-full mt-5 flex items-center justify-center">
      <Pagination total={data?.numOfPages}
      siblings={1}
      defaultValue={data?.page}
      withEdges onChange={(value) => setPage(value)}
      />
    </div>
